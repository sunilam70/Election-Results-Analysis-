...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_options:
        ...
        print(f"{county_name}:" f"{county_votes_percentage:.1f}%" f"({total_county_votes:,})")

         # 6e: Save the county votes to a text file.
        txt_file.write(str(total_county_votes))

         # 6f: Write an if statement to determine the winning county and get its vote count.
        if (total_county_votes > winning_county_count) and (county_votes_percentage > winning_county_percentage):
